...
const SelecaoDeMateria: React.FC = () => {
  ...
  const basicaClick = () => {
    navigate("/TelaVideoBasica"); // Redireciona para a tela de seleção de matérias
  };

  const mineClick = () => {
    navigate("/TelaVideoMine"); // Redireciona para a tela de seleção de matérias
  };
    ...
    <div className="container">
      ...
      <main className="main">
        ...
        <div className="card-container">
          ...
          <div className="card">
            <div onClick={basicaClick} className="card-content">
              <img
          ...
          <div className="card">
            <div onClick={mineClick} className="card-content">
              <img
