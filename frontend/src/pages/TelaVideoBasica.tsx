...
export default function SelecaodevideosBasica() {
  ...
  return (
    <div className="container">
      ...
      <header className="header">
        <div className="logo">
          <img src="/image/Header Images/Union.png" alt="" />
      ...
      <main className="main">
        ...
        <div className="card-container">
          ...
          <div className="card-tit">
            <div className="card">
              <div className="card-content">
                <a href="https://www.youtube.com/watch?v=Pl_w_k4aFKA&feature=youtu.be" target="_blank" rel="noopener noreferrer">
                <h1>VIDEO 01</h1>
                </a>
              </div>
            </div>
          ...
          <div className="card-tit">
            <div className="card">
              <div className="card-content">
                <a href="https://www.youtube.com/watch?v=Yxop1O9tWGE" target="_blank" rel="noopener noreferrer">
                <h1>VIDEO 02</h1>
                </a>
              </div>
            </div>
          ...
          <div className="card-tit">
            <div className="card">
              <div className="card-content">
                <a href="https://www.youtube.com/watch?v=0Dn9zt2NeZc" target="_blank" rel="noopener noreferrer">
                <h1>VIDEO 03</h1>
                </a>
              </div>
            </div>
